...
(async () => {
  ...
  await fs.writeFile("right-bundle-branch-block-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("right-bundle-branch-block-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
